getSettings(function(settings) {
	...
	var pseudoTaker = /\/([^\/]+)$/;
	var buildForumProfileUrl = function(pseudo) { return "http://forum.t411.io/profile/"+pseudo; };
	var buildT411ProfileUrl = function(pseudo) { return "http://www.t411.io/users/profile/"+pseudo; };
	...
	var improveProfilLinks = function() {
		...
		for (var i=0; i < metas.length; i++) {
			...
			var footResum = divMeta.querySelector('span.LastDiscussionTitle > a[href^="//www.t411.io/users/profile/"]');
			if (footResum != null) {
			...
			if (authorSection != null) {
				var pseudoLink = authorSection.querySelector('a[href^="//www.t411.io/users/profile/"]');
